...
class ShippingOptionSummary extends AbstractModel
{
     ...
     * the local time of the buyer. <br /> <br /> <span class="tablenote"> <b> Note:
     * </b> For the best accuracy, always include the <code> contextualLocation</code>
     ...
     * <b> Note: </b> For the best accuracy, always include the <code>
     * contextualLocation</code> values in the <a
     ...
     * VAT-inclusive pricing:<ul><li>Pass the <a
    ...
    /**
     * Indicates the type of shipping used to ship the item. Possible values are <code>
     * FIXED</code> (flat-rate shipping) and <code> CALCULATED</code> (shipping cost
