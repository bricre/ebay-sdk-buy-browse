...
class CoreItem extends AbstractModel
{
     ...
     * Note: </b> This container is returned if the <b> item_id</b> in the request is
     * for an item group (items with variations, such as color and size). This
     * container is also returned on a request for <b> item_group_ids</b>.</span>.
     *
