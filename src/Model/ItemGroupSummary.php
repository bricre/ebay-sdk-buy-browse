 ...
 * variations, such as the red shirt size L, is chosen as the "parent". All the
 * other items in the group are the children, such as the blue shirt size L, red
 * shirt size M, etc. <br /><br /><span class="tablenote"><b> Note: </b> This
 * container is returned only if the <b> item_id</b> in the request is an item
 * group (parent ID of an item with variations).</span>.
 */
class ItemGroupSummary extends AbstractModel
{
    /**
     * An array of containers with the URLs for images that are in addition to the
     * primary image of the item group.  The primary image is returned in the <b>
