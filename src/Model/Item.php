...
class Item extends AbstractModel
{
    ...
    /**
     * A list of add-on services that may be selected for the item or that may apply
     * automatically.
     *
     * @var \Ebay\Buy\Browse\Model\AddonService[]
     */
    public $addonServices = null;
     ...
     * Authenticity Guarantee program.<br /><br />Under the Authenticity Guarantee
     * program, the seller ships a purchased item to a a third-party authenticator who
     * inspects the item and provides an authentication card for it before the item is
    ...
    /**
     * A container for information about whether an item is from a verified
     * seller.</span>.
     *
     ...
     * the item aspects, including this aspect, are returned in the <b>
     ...
     * aspects, including this aspect, are returned in the <b> localizedAspects</b>
     * container.
     *
     * @var string
     */
     ...
     * the value specified in the <b>condition</b> field and provides full details for
    ...
    /**
     * The full description of the item that was created by the seller. This can be
    ...
    /**
     * The Eco Participation fee, a fee paid by the buyer that is applied to the cost
     * of the eventual disposal of the purchased item. The fee is remitted in full to
     * the eco organization.<br /><br />Currently, this value is required for
    ...
    /**
     * This field indicates if the item can be purchased using the Buy <a
     * href="/api-docs/buy/order/resources/methods">Order API</a>. <ul> <li>If the
     * value of this field is <code>true</code>, this indicates that the item can be
     * purchased using the <b> Order API</b>. </li>  <li>If the value of this field is
     * <code>false</code>, this indicates that the item cannot be purchased using the
     * <b> Order API</b> and must be purchased on the eBay site.</li> </ul>.
     *
     * @var bool
     */
    ...
    /**
     * This indicates if the item can be purchased using Guest Checkout in the <a
     * href="/api-docs/buy/order/resources/methods">Order API</a>. You can use this
     * flag to exclude items from your inventory that are not eligible for Guest
     * Checkout, such as gift cards.
     *
     * @var bool
     */
     ...
     * item aspects, including this aspect, are returned in the <b>
     * localizedAspects</b> container.
     *
     * @var string
     */
     ...
     * returned in the <b> additionalImages</b> container.
     *
     * @var \Ebay\Buy\Browse\Model\Image
     */
    public $image = null;
     ...
     * aspects, and other data. <br /><br />If the seller provided an ePID for the
     * item, the seller's value is returned in the <b> epid</b> field. <br /><br
     * /><span class="tablenote"><b> Note: </b> This field is returned only for
     * authorized Partners.</span>.
     *
     * @var string
     */
     ...
     * for the item by including the  <a
     ...
     * </b> eBay Partner Network, in order to be commissioned for your sales, you must
     * use this URL to forward your buyer to the ebay.com site. </span>.
     *
     * @var string
     */
    ...
    /**
     * A timestamp that indicates the date and time an item listing was created.<br
     * /><br />This value is returned in UTC format (yyyy-MM-ddThh:mm:ss.sssZ), which
     * can be converted into the local time of the buyer.
     *
     * @var string
     */
    ...
    /**
     * This timestamp indicates the date and time up to which the item can be
     * purchased.  This value is returned in UTC format (yyyy-MM-ddThh:mm:ss.sssZ),
     * which you can convert into the local time of the buyer.<br /><br /><span
     * class="tablenote"><b> Note: </b>This field is only returned for auction
     * listings.</span>.
     *
     * @var string
     */
    ...
    /**
     * The URL of the View Item page of the item. This enables you to include a "Report
     * Item on eBay" link that takes the buyer to the View Item page on eBay. From
     ...
     * that are being sold together.  <br /><br />A lot is a set of two or more items
     * included in a single listing that must be purchased together in a single order
     * line item. All the items in the lot are the same but there can be multiple items
     * in a single lot,  such as the package of batteries shown in the example below.
     * <br /><br /><table border="1"> <tr> <tr>  <th>Item</th>  <th>Lot Definition</th>
     * <th>Lot Size</th></tr>  <tr>  <td>A package of 24 AA batteries</td>  <td>A box
     * of 10 packages</td>  <td>10  </td> </tr>  <tr>  <td>A P235/75-15 Goodyear tire
     * </td>  <td>4 tires  </td>  <td>4  </td> </tr> <tr> <td>Fashion Jewelry Rings
     * </td> <td>Package of 100 assorted rings  </td> <td>100 </td> </tr></table>  <br
     * /><br /><span class="tablenote"><b>Note: </b>  Lots are not supported in all
     * categories.  </span>.
     *
     * @var int
     */
     ...
     * silk. All the item aspects, including this aspect, are returned in the <b>
     * localizedAspects</b> container.
     *
     * @var string
     */
    ...
    /**
     * The minimum price of the next bid, which means to place a bid it must be equal
    ...
    /**
     * (Primary Item Aspect) Text describing the pattern used on the item. For example,
     * paisley. All the item aspects, including this aspect, are returned in the <b>
     * localizedAspects</b> container.
     *
     * @var string
     */
     ...
     * discounts or shipping costs.<br /><br /><span class="tablenote"><b> Note:
     * </b>The price does include the value-added tax (VAT) for applicable
     ...
     * <code>EBAY_GB</code>) to see the VAT-inclusive pricing. For more information on
     * VAT, refer to <a
     ...
     * color, size, storage capacity, etc. <br /><br />When an item group is created,
     * one of the item variations, such as the red shirt size L, is chosen as the
     * "parent". All the other items in the group are the children, such as the blue
     * shirt size L, red shirt size M, etc.<br /><br /><span class="tablenote"><b>
     * Note: </b> This container is returned only if the <b> item_id</b> in the request
     * is for an item group (items with variations, such as color and size).</span>.
     *
     ...
     * not available for <em> all</em> items with an EEK rating and is returned only if
     * this information is available. The EEK rating of the item is returned in the <b>
     ...
     * item for. <p>If the highest bid is not equal to or higher than the reserve price
     * when the auction ends, the listing ends and the item is not sold.</p> <p><b>
     * Note: </b>This is returned only for auctions that have a reserve price.</p>.
     *
     * @var bool
     */
     ...
     *
     * @var \Ebay\Buy\Browse\Model\SellerCustomPolicy[]
     */
    public $sellerCustomPolicies = null;

    /**
     * An identifier generated/incremented when a seller revises the item. There are
     * two types of item revisions: <ul><li>Seller changes, such as changing the
     * title</li>  <li>eBay system changes, such as changing the quantity when an item
     * is purchased</li></ul> This ID is changed <em> only</em> when the seller makes a
     ...
     * including this aspect, are returned in the <b> localizedAspects</b> container.
     * <br /><br /><b> Valid Values: </b> <br />AU (Australia),  <br />BR (Brazil), <br
     * />CN (China),  <br />DE (Germany),  <br />EU (European Union),  <br /> FR
     * (France), <br /> IT (Italy),  <br />JP (Japan), <br />MX (Mexico),  <br />US
     * (USA), <br /> UK (United Kingdom) <br /><br />Code so that your app gracefully
     ...
     * can accurately compare prices.   <br /><br />For example: <br /><br
     * /><code>"unitPricingMeasure": "100g",<br /> "unitPrice": {<br
